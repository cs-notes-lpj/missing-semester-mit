...
1、the exericses of this lecture
...
6、验证一下如果使用 `ssh-copy-id` 是不是就不需要每次都输入 private key 的密码了（前提是 prvate key 被加密了）

7、read [this](https://www.hamvocke.com/blog/a-guide-to-customizing-your-tmux-conf/)

---

> after finishing these 2 questions, mv them to the Dotfiles section in the below !!!
