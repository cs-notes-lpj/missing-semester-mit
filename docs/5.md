...
ssh-agent-forwarding (for git-cli-operation in server) => see [this](https://www.ssh.com/academy/ssh/agent) and [this](https://docs.github.com/cn/developers/overview/using-ssh-agent-forwarding#setting-up-ssh-agent-forwarding)

read [this](https://www.hamvocke.com/blog/a-guide-to-customizing-your-tmux-conf/)

read [this](https://blog.flowblok.id.au/2013-02/shell-startup-scripts.html)
...
```shell
cat localfile | ssh remote_server > serverfile # >，而不使用 tee，试试 ？
```

---

> after finishing these 2 questions, mv them to the「Dotfiles section」on the top !!!
...
2、https://www.howtogeek.com/devops/what-is-ssh-agent-forwarding-and-how-do-you-use-it/ 
